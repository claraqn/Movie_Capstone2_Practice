...
async def on_chat_message(msg):
    ...
    if command == 'c':
        ...
        await bot.sendMessage(chat_id, '키보드창의 Location 버튼을 눌러 현재위치를 확인하세요.', reply_markup=markup)
    elif command == 'i':
...
TOKEN = '1429113658:AAEi5BmzzzV4jGKXWE3z8GabcA5MGSiVOgg'  # get token from command-line
